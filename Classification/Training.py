...
if __name__ == '__main__':
    ...
    features_test=[]
    label_test=[]
    file_train=open(r'C:\Users\QuocDai\Desktop\Khóa luận\Classification\Data\Result_Vector.txt', 'r',
                     encoding='UTF-8')
    file_test=open(r'C:\Users\QuocDai\Desktop\Khóa luận\Classification\Data\Data_test.txt', 'r',
                     encoding='UTF-8')
    ...
    est.training()
    est.save_model(r'C:\Users\QuocDai\Desktop\Khóa luận\Classification\Train\train.joblib')
