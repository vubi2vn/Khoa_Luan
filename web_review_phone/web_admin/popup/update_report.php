    ...
    <div class="modal-dialog" role="document">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <div class="text-box-info"><input class="form-control" type="text" name="txt_nreport" id="txt_nreport" placeholder="vd: Sai lớp"/></div>
            </div>
            <div class="form-group">
                <label class="label-info">Mô tả:</label>
                <div class="text-box-info"><input class="form-control" name="txt_ndescribe" id="txt_ndescribe" type="text" placeholder="vd: Sai lớp tích cực hoặc tiêu cực"/></div>
            </div>
